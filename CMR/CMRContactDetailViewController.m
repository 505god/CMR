...
-(void)initFooterView {
    ...
    [sendMessage setTitle:@"查看动态" forState:UIControlStateNormal];
    [sendMessage setTitle:@"查看动态" forState:UIControlStateHighlighted];
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    if ([CMRDataService shared].isEditing == YES) {
        [self setPerson:[[CMRDataService shared].temp_contact objectAtIndex:self.detail_index.row]];
