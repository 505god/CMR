...
- (void)tableViewInit {
    ...
    if ([CMRDataService shared].jurisdiction == 0) {
        self.textView.frame = CGRectMake(46, 6, 196, 32);
...
-(IBAction)showInputView:(id)sender {
    CGRect frame1 = self.textBar.frame;
    CGRect frame2 = self.inputBar.frame;
    [UIView animateWithDuration:0.5 delay:0.0 options: UIViewAnimationOptionBeginFromCurrentState animations:^{
        self.inputBar.frame = frame1;
        self.textBar.frame = frame2;
    }
                     completion:nil];
