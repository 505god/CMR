...
-(void)buttonAble {
    if ([CMRDataService shared].seleted_str) {
        ...
        UIButton *l_button_left2 = [[UIButton alloc] init];
//  [l_button_left setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
//	[l_button_left setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateHighlighted];
        [l_button_left2 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [l_button_left2 setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
        l_button_left2.titleLabel.font = [UIFont fontWithName:@"STHeitiSC-Medium" size:14.0];
        l_button_left2.titleLabel.textAlignment = NSTextAlignmentCenter;
        l_button_left2.frame = CGRectMake(0, 0, 50, 30);
        [l_button_left2 setTitle:[CMRDataService shared].seleted_str forState:UIControlStateNormal];
        
        [l_button_left2 addTarget:self action:@selector(shaixuanAction:) forControlEvents:UIControlEventTouchUpInside];
        UIBarButtonItem *l_barButtonItem2 = [[UIBarButtonItem alloc] initWithCustomView:l_button_left2];
        self.selectedBtn2 = l_barButtonItem2;
        self.navigationItem.leftBarButtonItem = self.selectedBtn2;
...
//	[l_button setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateHighlighted];
    ...
    UIButton *l_button_left = [[UIButton alloc] init];
//  [l_button_left setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
//	[l_button_left setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateHighlighted];
	[l_button_left setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
	[l_button_left setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
	l_button_left.titleLabel.font = [UIFont fontWithName:@"STHeitiSC-Medium" size:14.0];
	l_button_left.titleLabel.textAlignment = NSTextAlignmentCenter;
	l_button_left.frame = CGRectMake(0, 0, 50, 30);
	[l_button_left setTitle:@"筛选" forState:UIControlStateNormal];
    
	[l_button_left addTarget:self action:@selector(shaixuanAction:) forControlEvents:UIControlEventTouchUpInside];
	UIBarButtonItem *l_barButtonItem = [[UIBarButtonItem alloc] initWithCustomView:l_button_left];
    self.selectedBtn1 = l_barButtonItem;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.searchBar.text length] <= 0) {
        ...
        if (![contact.remark isKindOfClass:[NSNull class]] && contact.remark!=nil) {
