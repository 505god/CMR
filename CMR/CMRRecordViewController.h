...
@interface CMRRecordViewController : UIViewController<UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,SendMessageInterfaceDelegate,EditInterfaceDelegate,UIScrollViewDelegate>
