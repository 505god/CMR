...
//        if ([CMRDataService shared].chat_person_id>0) {
//            [[NSNotificationCenter defaultCenter] postNotificationName:@"reloadCList" object:apsInfo];
//        }
//        if ([CMRDataService shared].isChating == YES) {
//            [CMRDataService shared].isChating = NO;
//        }else {
//            //最近联系人
